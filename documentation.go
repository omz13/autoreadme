...
// # Fork
//
// This module is a fork of github.com/jimmyfrasche/autoreadme. Upstream is
// unmaintained; we publish omz13.com/go/autoreadme and fixed a few things that
// bit us in production README generation:
//
